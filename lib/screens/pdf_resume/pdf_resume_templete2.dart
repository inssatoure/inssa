...
void pdfResumeTemplete2(Map<String, dynamic> resumeData) async {
  ...
  pw.Widget contacts() {
    return pw.Column(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      children: [
        titleText(titleText: "Contacts", color: PDFColors.white_color),
        pw.SizedBox(height: 7),
        resumeData['customerLocationtext'] != ""
            ? titleSubText(
                titleSubText: resumeData['customerLocationtext'],
                color: PDFColors.white_color.shade(0.53))
            : pw.SizedBox.shrink(),
  ...
  pw.Widget buildSkillProgressBar(String skill, double level) {
    return pw.Column(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      children: [
        titleSubText(titleSubText: skill, color: PDFColors.white_color),
        ...
        pw.ClipRRect(
          ...
          child: pw.SizedBox(
            ...
            child: pw.LinearProgressIndicator(
                value: customerSkillList.isEmpty ? 0.8 : level / 100.0,
                backgroundColor: PDFColors.authBgcolor.shade(0.75),
                valueColor: PDFColors.white_color),
          ),
        ),
                ...
                children: List.generate(
                  ...
                  (index) => pw.Column(
                    ...
                    children: [
                      ...
                      pw.SizedBox(height: kTextPadding + 1),
                      titleSubText(
                          titleSubText: customerEmploymentList[index].address),
                      pw.SizedBox(height: 10),
                    ],
                  ),
                ),
  ...
  pw.Widget buildProfileDetails() {
    return pw.Container(
      width: 217,
      padding: const pw.EdgeInsets.symmetric(horizontal: 20, vertical: 27),
      ...
      child: pw.Column(
        ...
        children: [
          ...
          pw.Text(
            ...
            style: pw.TextStyle(
                font: hind, fontSize: 13, color: PDFColors.white_color),
          ),
          pw.SizedBox(height: kDefaultPadding * 1.5),
          contacts(),
          pw.SizedBox(height: kDefaultPadding * 1.5),
