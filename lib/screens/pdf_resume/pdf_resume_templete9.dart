...
void pdfResumeTemplete9(Map<String, dynamic> resumeData) async {
  ...
  final jost = await PDFFonts.jost();
      ...
      children: [
        pw.Container(
          ...
          decoration: pw.BoxDecoration(
            border: pw.Border(
              bottom:
                  pw.BorderSide(color: PDFColors.text_color_black, width: 2),
            ),
          ),
          child: pw.Text(
            titleText,
                    ...
                    children: [
                      pw.Container(
                        ...
                        decoration: pw.BoxDecoration(
                          border: pw.Border(
                            left: pw.BorderSide(
                                color: PDFColors.lightorengecolor, width: 2),
                          ),
                        ),
                        child: pw.Column(
                          children: [
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.only(left: 5.5),
                        child: pw.Container(
                            height: 12,
                            width: 12,
                            decoration: pw.BoxDecoration(
    ...
    return pw.Row(
      ...
      children: [
        pw.Container(
          ...
          decoration: pw.BoxDecoration(
            color: PDFColors.primaryColor,
            borderRadius: pw.BorderRadius.circular(kTextPadding),
          ),
          child: pw.Container(
              height: 14,
              width: 14,
            ...
            pw.Row(
              ...
              children: [
                  ...
                  child: pw.Row(
                    ...
                    children: [
                      pw.Container(
                        ...
                        width: 20,
                        decoration:
                            pw.BoxDecoration(color: PDFColors.primaryColor),
                      ),
                      pw.SizedBox(width: 10),
                      pw.Expanded(
                        child: pw.Column(
                ...
                pw.Container(
                  height: 93,
                  width: 93,
                  margin: const pw.EdgeInsets.only(right: 27),
                  decoration: pw.BoxDecoration(
                    shape: pw.BoxShape.circle,
                    image:
